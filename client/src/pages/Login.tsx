      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663342930280/bDyKxbJirDkukZmvFFZQ8p/logo-final-96_4457caf3.png" alt="Cadastro Digital" className="w-16 h-16 mb-4 mx-auto rounded-xl" />
