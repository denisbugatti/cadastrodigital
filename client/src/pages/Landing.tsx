    ...
    >
      <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663342930280/bDyKxbJirDkukZmvFFZQ8p/shield-logo-128_38a89225.png" alt="Cadastro Digital" className="w-8 h-8 rounded-lg" />
    ...
    <div className="min-h-screen" style={{ background: BG, color: "#fff" }}>
      ...
      <footer className="py-10 border-t border-white/[0.04]">
        <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663342930280/bDyKxbJirDkukZmvFFZQ8p/shield-logo-128_38a89225.png" alt="Cadastro Digital" className="w-7 h-7 rounded-md" />
