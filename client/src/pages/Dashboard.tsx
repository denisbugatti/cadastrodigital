        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3 sm:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <Link href="/" className="flex items-center gap-2 sm:gap-2.5">
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663342930280/bDyKxbJirDkukZmvFFZQ8p/logo-final-96_4457caf3.png" alt="Cadastro Digital" className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg" />
